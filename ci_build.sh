...
default|default-Werror|default-with-docs|valgrind|clang-format-check)
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.0 https://github.com/42ity/tntnet.git tntnet
        cd ./tntnet
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.0 https://github.com/42ity/tntdb.git tntdb
        cd ./tntdb
        cd ./tntdb
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.0 https://github.com/42ity/fty-common-db.git fty-common-db
        cd ./fty-common-db
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.0 https://github.com/42ity/fty-common-rest.git fty-common-rest
        cd ./fty-common-rest
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
