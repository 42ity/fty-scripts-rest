...
default|default-Werror|default-with-docs|valgrind|clang-format-check)
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/cxxtools.git cxxtools
        cd ./cxxtools
        CCACHE_BASEDIR=${PWD}
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/log4cplus.git log4cplus
        cd ./log4cplus
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/fty-common-logging.git fty-common-logging
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/libsodium.git libsodium
        cd ./libsodium
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/libzmq.git libzmq
        cd ./libzmq
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/czmq.git czmq
        cd ./czmq
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/malamute.git malamute
        cd ./malamute
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/fty-common.git fty-common
        cd ./fty-common
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/fty-common-mlm.git fty-common-mlm
        cd ./fty-common-mlm
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/tntnet.git tntnet
        cd ./tntnet
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/tntdb.git tntdb
        cd ./tntdb
        cd ./tntdb
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/fty-common-db.git fty-common-db
        cd ./fty-common-db
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        cd ./tmp-deps
        $CI_TIME git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/fty-common-rest.git fty-common-rest
        cd ./fty-common-rest
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
